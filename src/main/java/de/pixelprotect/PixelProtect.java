...
public final class PixelProtect extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        try {
            ...
            database = new Database(databaseFile, getConfig().getInt("storage.queue-capacity", 10_000),
        ...
        getLifecycleManager().registerEventHandler(LifecycleEvents.COMMANDS, commands ->
                commands.registrar().register(command.create().build(), "Audit and rollback world changes"));
        ...
        if (getConfig().getBoolean("retention.enabled", true)) {
            ...
            Bukkit.getGlobalRegionScheduler().runAtFixedRate(this,
                    task -> database.purgeBefore(System.currentTimeMillis() - days * 86_400_000L), 20L, 24_000L);
        }
