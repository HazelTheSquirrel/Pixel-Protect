...
public final class MessageService {
    ...
    public static String action(ActionType action) {
        ...
        return switch (action) {
            ...
            case INVENTORY -> "Spielerinventar geändert";
            ...
            case CRAFT -> "Herstellung";
            case TRADE -> "Handel";
            case WORLD_EDIT -> "Weltbearbeitung";
            case DECAY -> "Verfall";
            case MOISTURE -> "Feuchtigkeit";
            case SCULK -> "Sculk";
            case CAULDRON -> "Kessel";
            case DISPENSE -> "Ausgabe";
            case COMPOST -> "Kompostierung";
            case SHEAR -> "Scherenaktion";
            case TNT_PRIME -> "TNT gezündet";
            case BLOCK_BREAK -> "Block durch Mechanik abgebaut";
            case VAULT -> "Vault-Zustand";
            case PORTAL -> "Portal";
            case STRUCTURE -> "Struktur";
            case BOOKSHELF -> "Bücherregal";
            case FLOWER_POT -> "Blumentopf";
